...
public class ControladorGraficaEficienciaTareaAsignadaPorEmpleadosSubAlternos
	...
	public ControladorGraficaEficienciaTareaAsignadaPorEmpleadosSubAlternos() {
	...
	public ListModel<Usuario> getEmpleados() {
		...
		(usuarioDAO.obtenerUsuariosEmpleadosActivosPorSupervisor(usuarioSession
				.getId()));
	...
	public void generarGraficaPorEmpleadoSubAlternoSeleccionado() {
