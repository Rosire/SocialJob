...
public class ControladorGraficaEficienciaTareaAsignadaPorCargoDeLaEmpresa
	...
	public ControladorGraficaEficienciaTareaAsignadaPorCargoDeLaEmpresa() {

	}

	public ListModel<Cargo> getCargos() {
		listaCargosModel = new ListModelList<Cargo>(
				cargoDAO.obtenerCargosActivosPorEmpresa(usuarioSession
						.getEmpresa().getId()));
